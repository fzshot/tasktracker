defmodule TasktrackerWeb.TimeblockControllerTest do
  ...
  @create_attrs %{interval: 42, start_time: ~N[2010-04-17 14:00:00.000000], stop_time: ~N[2010-04-17 14:00:00.000000]}
  ...
  def fixture(:timeblock) do
    {:ok, timeblock} = Posts.create_timeblock(@create_attrs)
    timeblock
  end
